          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-blue-900/10 border border-blue-900/30 rounded-lg p-4 flex gap-3">
              ...
              <p className="text-xs text-blue-200/70 leading-relaxed">
                MPFA analyzes visual and textual components to identify logical fallacies, emotional manipulation, and credibility gaps. Results are generated by Gemini AI models.
              </p>
            </div>
          </div>
